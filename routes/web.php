...
use App\Http\Controllers\apps\PegawaiList;
use App\Http\Controllers\apps\EselonList;
use App\Http\Controllers\apps\GolonganList;
...
/*
|--------------------------------------------------------------------------
| Rute yang Tidak Memerlukan Login (Publik)
|--------------------------------------------------------------------------
*/
// Rute utama akan mengarahkan ke halaman login jika belum terautentikasi
// Route::get('/login', function () {
//   return redirect()->route('login');
// })->name('home');

// Semua rute otentikasi (login, register, lupa password, dll.)
Route::get('/login', [LoginBasic::class, 'index'])
    ->name('login')
    ->middleware('locked');

Route::post('/proses-login', [LoginBasic::class, 'login'])->name('login.process');

// Rute untuk halaman akun terkunci
Route::get('/terkunci/{encryptedSeconds}', function ($encryptedSeconds) {
  try {
      $seconds = Crypt::decrypt($encryptedSeconds);
  ...
  return view('content.authentications.auth-locked-account', [
      'seconds' => $seconds,
...
Route::middleware('auth')->group(function () {
  // Rute utama setelah login berhasil
  ...
  // ========== ROUTE PEGAWAI ============= //
  // Route::get('/pegawai', [PegawaiList::class, 'index'])->name('app-pegawai-list');
  // Rute untuk menampilkan halaman utama
  Route::get('/pegawai', [PegawaiList::class, 'index'])->name('pegawai.index');

  // Rute khusus untuk mengambil data via AJAX untuk DataTables
  Route::get('/pegawai/data', [PegawaiList::class, 'data'])->name('pegawai.data');

  // Rute untuk proses CRUD via AJAX
  Route::post('/pegawai', [PegawaiList::class, 'store'])->name('pegawai.store');
  Route::get('/pegawai/{pegawai}/edit', [PegawaiList::class, 'edit'])->name('pegawai.edit');
  Route::put('/pegawai/{pegawai}', [PegawaiList::class, 'update'])->name('pegawai.update');
  Route::delete('/pegawai/{pegawai}', [PegawaiList::class, 'destroy'])->name('pegawai.destroy');

  // =========== ROUTE ESELON ============== //
  Route::get('/eselon', [EselonList::class, 'index'])->name('pegawai.master.eselon.index');
  Route::get('/eselon/data', [EselonList::class, 'data'])->name('eselon.data');

  Route::post('/eselon', [EselonList::class, 'store'])->name('eselon.store');
  Route::get('/eselon/{eselon}/edit', [EselonList::class, 'edit'])->name('eselon.edit');
  Route::put('/eselon/{eselon}', [EselonList::class, 'update'])->name('eselon.update');
  Route::delete('/eselon/{eselon}', [EselonList::class, 'destroy'])->name('eselon.destroy');

  // =========== ROUTE GOLONGAN ============== //
  Route::get('/golongan', [GolonganList::class, 'index'])->name('pegawai.master.golongan.index');
  Route::get('/golongan/data', [GolonganList::class, 'data'])->name('golongan.data');

  Route::post('/golongan', [GolonganList::class, 'store'])->name('golongan.store');
  Route::get('/golongan/{golongan}/edit', [GolonganList::class, 'edit'])->name('golongan.edit');
  Route::put('/golongan/{golongan}', [GolonganList::class, 'update'])->name('golongan.update');
  Route::delete('/golongan/{golongan}', [GolonganList::class, 'destroy'])->name('golongan.destroy');

  // =========== ROUTE JABATAN ============== //
  Route::get('/jabatan', [JabatanList::class, 'index'])->name('pegawai.master.jabatan.index');
  Route::get('/jabatan/data', [JabatanList::class, 'data'])->name('jabatan.data');

  Route::post('/jabatan', [JabatanList::class, 'store'])->name('jabatan.store');
  Route::get('/jabatan/{jabatan}/edit', [JabatanList::class, 'edit'])->name('jabatan.edit');
  Route::put('/jabatan/{jabatan}', [JabatanList::class, 'update'])->name('jabatan.update');
  Route::delete('/jabatan/{jabatan}', [JabatanList::class, 'destroy'])->name('jabatan.destroy');

  // =========== ROUTE PANGKAT ============== //
  Route::get('/pangkat', [PangkatList::class, 'index'])->name('pegawai.master.pangkat.index');
  Route::get('/pangkat/data', [PangkatList::class, 'data'])->name('pangkat.data');

  Route::post('/pangkat', [PangkatList::class, 'store'])->name('pangkat.store');
  Route::get('/pangkat/{pangkat}/edit', [PangkatList::class, 'edit'])->name('pangkat.edit');
  Route::put('/pangkat/{pangkat}', [PangkatList::class, 'update'])->name('pangkat.update');
