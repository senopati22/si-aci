      ...
      <div class="d-flex align-items-end row">
        <div class="col-md-8 order-2 order-md-1">
          <div class="card-body">
            ...
            <p class="mb-0">SI ACI sendiri adalah singkatan dari Sistem Informasi Aku Cinta Indonesia</p>
            <p>Aplikasi Website ini dikembangkan langsung oleh Badan Kesatuan Bangsa dan Politik Kota Surabaya</p>
            <!-- <a href="javascript:;" class="btn btn-primary">View Profile</a> -->
          </div>
        </div>
        <div class="col-md-4 text-center text-md-end order-1 order-md-2">
          <div class="card-body pb-0 px-0 pt-2">
            <img src="{{asset('assets/img/illustrations/dashboard-welcome-'.$configData['style'].'.png')}}" height="186" class="scaleX-n1-rtl" alt="View Profile" data-app-light-img="illustrations/dashboard-welcome-light.png" data-app-dark-img="illustrations/dashboard-welcome-dark.png">
          </div>
        </div>
      </div>
    </div>
